...
| | Isaac | MuJoCo | 모수 |
| --- | --- | --- | --- |
| 끝까지 완주 | 0.765 | 0.775 | 17개 |
| 전역 오차 | 108.3 mm | 101.3 mm | 14개 |
| 관절 각도 | 0.594 rad | 0.593 rad | 14개 |

각 100회 시행입니다. 오차는 완주한 시행에서만 내므로, 완주가 0인 셋
(`obstacles2_subject1`, `walk3_subject1`, `walk3_subject4`)은 오차 두 줄에서
빠집니다. 그 셋을 빼고 세면 완주율은 Isaac 0.929, MuJoCo 0.941입니다.
